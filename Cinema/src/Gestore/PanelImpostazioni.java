...
//                    impostazioni.add(refresh);
        ...
        submit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (controller.scriviConfig(new Config(Double.parseDouble(text[0].getText()), Double.parseDouble(text[1].getText()), Double.parseDouble(text[2].getText()), Double.parseDouble(text[3].getText()), Double.parseDouble(text[4].getText()), Integer.parseInt(text[5].getText())))) {
