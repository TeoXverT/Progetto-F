...
/**
 *    Pannello contenente l'interfaccia che permette l'inserimento di nuove sale nel DB
 *          Si suddivide su due interfaccie: 
 *              -la prima serve per definere i parametri dimensionali della stanza
 *              -la seconda permette di personalizzare la stanza a piacimento 
 *                      
 * 
 */
