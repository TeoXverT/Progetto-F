...
/**
 * Pannello che tramite la sua interfaccia visaulizza il tempo rimanente al cliente per pagare prima che il suo bilgetto venga cancellato, inoltre permette di confermare il pagamento (DUBUG feature)
 *
*/
...
public class PanelWaiting extends JPanel {
    ...
    public PanelWaiting(final Booking booking) {
